...
public partial class _Default : System.Web.UI.Page
{
    ...
    const string filePathLeidiniai = (@"D:\op\Data\Leidiniai\");
    const string filePathPrenumeratoriai = (@"D:\op\Data\Prenumeratoriai\");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        leidejai.Sort();
        SpausdintiPajamas(Rez, "Surikuotos visų mėnesių leidėjų pajamos:", leidejai);
    }
